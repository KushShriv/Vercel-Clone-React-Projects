        ...
        <Card className="w-full max-w-md mt-8">
          ...
          <CardContent>
            ...
            <Button className="w-full" variant="outline">
              <a
                href={`http://${uploadId}.dev.100xdevs.com:3001/index.html`} //Chagne dev.100xdevs.com:3001 to localhost:3001 for running locally and your wildcard domain for production
                target="_blank"
              >
                Visit Website
              </a>
